...
export const metadata: Metadata = {
  ...
  description:
    "Luxury custom home building, renovation, and owner's representation in Denver, Colorado. 20+ years of trusted expertise in Cherry Creek, Highlands, Wash Park, and beyond.",
  openGraph: {
